...
class Song(models.Model):
    ...
    title = models.CharField(max_length=50, help_text="name - artist [album]")
    updated_title= models.CharField(max_length=50, help_text="name - artist [album]", blank=True, null=True)
