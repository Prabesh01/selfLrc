"""
Django settings for self_lrc project.
...
SECRET_KEY = 'django-insecure-q$rcmur)4n-lrmm68d_#598dcji#cz$7mhwzwohq7!22(n(be!'
...
WSGI_APPLICATION = 'self_lrc.wsgi.application'
